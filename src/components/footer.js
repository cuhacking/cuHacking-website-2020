...
import { faFacebookF, faLinkedin, faInstagram, faTwitter, faGithub } from '@fortawesome/free-brands-svg-icons'
...
const madeWithLove = () => (
  <p id={styles.madeWithLove}>
    Made with <FontAwesomeIcon icon={faHeart} size='sm' /> by the{' '}
    <span style={{ color: 'var(--lightPrimaryColour)' }}>cu</span>Hacking team
  </p>
)
      ...
      <div className={styles.row} id={styles.contentWrapper}>
        <div className={styles.footerContent} id={styles.footerDescription}>
          ...
          <p className={styles.nomargin}>
            {' '}
            cuHacking 2020 is set to provide an unforgettable experience, where students can enhance technical skills,
            make new friends, and create genuine connections with industry professionals. We can't wait to see you
            there!
          </p>
        </div>
        ...
        <div className={styles.footerContent} id={styles.contactForm}>
          ...
          <p className={styles.nomargin}>
            {' '}
            Check us out on social. Or, email us at{' '}
            <a href='mailto:info@cuhacking.com' id={styles.mailTo}>
              {' '}
              info@cuHacking.com{' '}
            </a>
          </p>
